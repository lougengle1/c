...
#define			KIWI_POLL_DEVICE_ID			0x0003
...
struct cherry_kiwi_adapter
{
	...
	struct task_struct*			carry_task;			/// 处理控制消息线程 add by lisen
};
...
extern struct cherry_kiwi_adapter		g_driver_data;
#endif